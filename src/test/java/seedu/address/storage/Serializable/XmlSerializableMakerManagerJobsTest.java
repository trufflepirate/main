...
public class XmlSerializableMakerManagerJobsTest {
    ...
    private static final Path TEST_DATA_FOLDER = Paths.get("src", "test", "data", "XmlSerializableMakerManagerJobsTest");
    ...
    public void toModelType_validJobsFile_success() throws Exception {
        XmlSerializableMakerManagerJobs dataFromFile = XmlUtil.getDataFromFile(VALID_JOBS_FILE, XmlSerializableMakerManagerJobs.class);
    ...
    public void toModelType_invalidJobsFile_throwsNullPointerException() throws Exception {
        XmlSerializableMakerManagerJobs dataFromFile = XmlUtil.getDataFromFile(INVALID_JOBS_FILE, XmlSerializableMakerManagerJobs.class);
    ...
    public void toModelType_duplicateJobs_throwsIllegalValueException() throws Exception {
        XmlSerializableMakerManagerJobs dataFromFile = XmlUtil.getDataFromFile(DUPLICATE_JOBS_FILE, XmlSerializableMakerManagerJobs.class);
