...
* It is *written in OOP fashion*. It provides a *reasonably well-written* code that is based on Address Book (level 4), a sample java program written for students to learn software engineering.
* Features:
