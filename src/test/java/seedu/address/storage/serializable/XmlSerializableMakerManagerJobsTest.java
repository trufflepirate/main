...
public class XmlSerializableMakerManagerJobsTest {
    ...
    public void toModelType_validJobsFile_success() throws Exception {
        ...
        AddressBook makerManagerJobsFile = dataFromFile.toModelType();
        AddressBook validMakerManagerJobs = ValidJobs.getJobsData();
        assertEquals(makerManagerJobsFile, validMakerManagerJobs);
    }
