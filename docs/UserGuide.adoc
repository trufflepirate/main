...
Adds a print job to the queue. +
    ...
    Format: add_print n/JOB NAME m/MACHINE NAME on/JOB OWNER NAME pr/JOB PRIORITY d/JOB DURATION jn/JOB NOTE [t/TAG]
...
Adds a print job to the machine's queue. +
   ...
   Format: addJobToMachine n/JOB NAME m/MACHINE NAME

   Examples:
   addJobToMachine n/iDCP_project m/PRINTER_1
...
. addJobToMachine n/JOB NAME m/MACHINE NAME
. requestDeletion n/iDCP
